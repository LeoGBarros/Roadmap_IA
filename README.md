# Roadmap_IA
# 🤖 Trilha de IA & Agentes — Guia de Estudos por Perfil

> Este roadmap apresenta um **guia de estudos voltado ao uso, integração e desenvolvimento com Inteligência Artificial e Agentes**, indicando **ferramentas, conceitos e recursos essenciais** para cada nível de atuação.
>
> Ele **não está associado a definições formais de cargos**, mas serve como inspiração e orientação para quem deseja evoluir no uso de IA no contexto profissional.
>
> A proposta é servir como **um norte de estudos** e apresentar temas relacionados ao cotidiano de cada perfil, do estagiário ao sênior.
...
- [💻 Desenvolvedores](#-desenvolvedores)
  - [Estagiário DEV](#-estagiário-dev)
  - [Desenvolvedor Júnior](#-desenvolvedor-júnior)
  - [Desenvolvedor Pleno](#-desenvolvedor-pleno)
  - [Desenvolvedor Sênior](#-desenvolvedor-sênior)
- [🧪 QA — Quality Assurance](#-qa--quality-assurance)
  - [Estagiário QA](#-estagiário-qa)
  - [QA Júnior](#-qa-júnior)
  - [QA Pleno](#-qa-pleno)
  - [QA Sênior](#-qa-sênior)
- [📋 Gestão — PMs e Coordenadores](#-gestão--pms-e-coordenadores)
...
**Objetivo:** Entender o que é IA generativa, conhecer as principais ferramentas e começar a usar IA no dia a dia de desenvolvimento.
...
### 🛠️ Conhecendo as principais ferramentas de IA

#### 🔹 ChatGPT (OpenAI)
- [ChatGPT para Devs — Primeiros Passos](https://www.youtube.com/watch?v=pGOyw_M1mNE) — Vídeo (PT)
- [Documentação oficial do ChatGPT](https://help.openai.com/en/collections/3742473-chatgpt) — Docs (EN)
- [ChatGPT Prompt Engineering for Developers — DeepLearning.AI](https://www.deeplearning.ai/short-courses/chatgpt-prompt-engineering-for-developers/) — Curso gratuito (EN)
...
#### 🔹 GitHub Copilot
- [GitHub Copilot — O que é e como usar](https://www.youtube.com/watch?v=Fi3AJZZregI) — Vídeo (PT)
- [GitHub Copilot Docs](https://docs.github.com/en/copilot) — Docs (EN)
- [GitHub Copilot para Iniciantes](https://learn.microsoft.com/pt-br/training/modules/introduction-to-github-copilot/) — Curso (PT)

#### 🔹 Claude (Anthropic)
- [Introdução ao Claude — Anthropic](https://www.anthropic.com/claude) — Site oficial
- [Claude Docs — Como funciona](https://docs.anthropic.com/en/docs/intro-to-claude) — Docs (EN)
- [Como usar o Claude para desenvolvimento](https://www.youtube.com/watch?v=QmjT2_Xk1M4) — Vídeo (EN)
...
### 📚 Como LLMs Funcionam (Teoria Essencial)

- [Large Language Models explained briefly](https://www.youtube.com/watch?v=LPZh9BOjkQs) — Vídeo (EN)
- [How ChatGPT Works Technically | ChatGPT Architecture](https://www.youtube.com/watch?v=bSvTVREwSNw) — Vídeo (EN)
- [Attention Is All You Need — Paper Original (Transformers)](https://arxiv.org/abs/1706.03762) — Paper (EN)
- [Illustrated Transformer — Jay Alammar](https://jalammar.github.io/illustrated-transformer/) — Artigo Visual (EN)
- [3Blue1Brown — Neural Networks](https://www.youtube.com/playlist?list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi) — Playlist (EN)
- [Andrej Karpathy — Intro to Large Language Models](https://www.youtube.com/watch?v=zjkBMFhNj_g) — Vídeo (EN)
- [Como funcionam os Tokens em LLMs](https://www.youtube.com/watch?v=zduSFxRajkE) — Vídeo (EN)
- [OpenAI Tokenizer — ferramenta interativa](https://platform.openai.com/tokenizer) — Ferramenta
...
- [Gerenciando contexto e janela de tokens](https://platform.openai.com/docs/guides/text-generation/managing-tokens) — Docs (EN)

---

### 🧠 Engenharia de Prompt — Nível Intermediário

- [Prompt Engineering Guide — Completo](https://www.promptingguide.ai/pt) — Guia (PT)
- [OpenAI Prompt Engineering Best Practices](https://platform.openai.com/docs/guides/prompt-engineering) — Docs (EN)
- [Anthropic Prompt Engineering Docs](https://docs.anthropic.com/en/docs/build-with-claude/prompt-engineering/overview) — Docs (EN)
...
**Objetivo:** Construir aplicações com IA, implementar agentes, RAG e integrações avançadas. Entender boas práticas de segurança e avaliação de modelos.
...
- [LlamaIndex Docs](https://docs.llamaindex.ai/en/stable/) — Docs (EN)

#### 🔹 CrewAI
- [CrewAI — Multi-Agent Framework](https://www.youtube.com/watch?v=kJvXT25LkwA) — Vídeo (EN)
- [CrewAI Docs](https://docs.crewai.com/) — Docs (EN)

#### 🔹 AutoGen (Microsoft)
- [AutoGen — Agentes Multi-Modelo](https://www.youtube.com/watch?v=vU2S6dVf79M) — Vídeo (EN)
- [AutoGen Docs](https://microsoft.github.io/autogen/) — Docs (EN)

---

### 📦 RAG — Retrieval-Augmented Generation

- [RAG explicado em 5 minutos](https://www.youtube.com/watch?v=T-D1OfcDW1M) — Vídeo (EN)
- [RAG do zero com Python e LangChain](https://www.youtube.com/watch?v=tcqEUSNCn8I) — Vídeo (EN)
- [Building RAG Applications — DeepLearning.AI](https://www.deeplearning.ai/short-courses/building-evaluating-advanced-rag/) — Curso (EN)
- [Vector Databases — o que são e por que importam](https://www.youtube.com/watch?v=klTvEwg3oJ4) — Vídeo (EN)
- [Pinecone Docs — Banco Vetorial](https://docs.pinecone.io/home) — Docs (EN)
- [ChromaDB — Banco Vetorial Open Source](https://docs.trychroma.com/) — Docs (EN)
- [FAISS — Facebook AI Similarity Search](https://faiss.ai/index.html) — Docs (EN)
...
### 🔐 Segurança, Avaliação e Boas Práticas
...
**Objetivo:** Arquitetar soluções de IA escaláveis, liderar times, realizar fine-tuning e avaliação de modelos, e tomar decisões estratégicas sobre adoção de IA.

---

### 🧬 Fine-Tuning e Modelos Customizados

- [OpenAI Fine-Tuning Guide](https://platform.openai.com/docs/guides/fine-tuning) — Docs (EN)
- [Fine-Tuning LLMs — DeepLearning.AI](https://www.deeplearning.ai/short-courses/finetuning-large-language-models/) — Curso (EN)
- [LoRA e QLoRA — Fine-Tuning eficiente explicado](https://www.youtube.com/watch?v=Us5ZFp16PaU) — Vídeo (EN)
- [Hugging Face — Repositório de modelos e fine-tuning](https://huggingface.co/docs/transformers/training) — Docs (EN)
- [Treinando modelos com dados proprietários](https://www.youtube.com/watch?v=eC6Hd1hFvos) — Vídeo (EN)
...
### 🧪 Avaliação Avançada e Observabilidade

- [Langfuse — Observabilidade para LLMs (Open Source)](https://langfuse.com/docs) — Docs (EN)
...
- [Papers With Code — LLM e Agentes](https://paperswithcode.com/methods/category/language-models) — Plataforma (EN)
- [Arxiv — AI/ML Papers](https://arxiv.org/list/cs.AI/recent) — Plataforma (EN)
- [The Illustrated GPT-2 — Jay Alammar](https://jalammar.github.io/illustrated-gpt2/) — Artigo (EN)
- [State of AI Report 2024](https://www.stateof.ai/) — Relatório (EN)
- [Anthropic Research — Building Safe AI Systems](https://www.anthropic.com/research) — Artigos (EN)

---

### 🧭 Liderança Técnica em Times com IA

- [Structuring AI Teams — a16z](https://a16z.com/structuring-ai-teams/) — Artigo (EN)
- [AI Engineering — The Emerging Role](https://www.youtube.com/watch?v=C0E5mBxMYXg) — Vídeo (EN)
- [Responsible AI Leadership — Google](https://ai.google/responsibility/) — Docs (EN)
- [Principais erros em adoção de IA em empresas](https://www.youtube.com/watch?v=bVR7RIqyFqU) — Vídeo (PT)

---

### 🔗 Referências Sênior DEV

- [Hugging Face Hub](https://huggingface.co/) — EN
- [OpenAI Cookbook](https://cookbook.openai.com/) — EN
- [LangChain Hub](https://smith.langchain.com/hub) — EN
- [AI Safety Papers](https://www.alignmentforum.org/) — EN
- [Google DeepMind Research](https://deepmind.google/research/) — EN
- [Anthropic Research](https://www.anthropic.com/research) — EN
...
**Objetivo:** Entender o contexto de IA generativa e começar a usar ferramentas de IA para apoiar tarefas básicas de qualidade.
...
**Objetivo:** Usar IA para geração e automação de testes, integrar ferramentas de IA com o fluxo de qualidade e começar a explorar testes de aplicações com IA.
...
**Objetivo:** Testar aplicações com IA integrada, criar estratégias de qualidade para sistemas inteligentes e usar IA na cobertura avançada de testes.
...
**Objetivo:** Definir estratégias de qualidade para sistemas de IA, liderar avaliação de modelos, criar frameworks de testes para produtos inteligentes.
...
### 📐 Métricas e KPIs de Qualidade em IA
...
# 📋 Gestão — PMs e Coordenadores

**Objetivo:** Compreender o impacto da IA em projetos, usar IA para produtividade, tomada de decisão, gestão de times e comunicação, sem necessidade de conhecimento técnico profundo.
...
- [PMI — AI in Project Management](https://www.pmi.org/learning/thought-leadership/artificial-intelligence) — EN
- [HBR — AI and Management](https://hbr.org/topic/subject/artificial-intelligence) — EN
- [McKinsey — The State of AI 2024](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai) — EN
- [MIT Sloan — Artificial Intelligence](https://sloanreview.mit.edu/topic/artificial-intelligence/) — EN
- [Google AI for Managers](https://grow.google/intl/pt-BR/cursos-e-ferramentas/?category=ai) — PT
- [Microsoft AI Skills](https://learn.microsoft.com/pt-br/ai/) — PT

---

# 🔗 Referências Gerais

## 📚 Cursos e Plataformas de Estudo

| Plataforma | Descrição | Idioma |
|---|---|---|
| [DeepLearning.AI](https://www.deeplearning.ai/short-courses/) | Cursos gratuitos de IA com Andrew Ng | EN |
| [fast.ai](https://www.fast.ai/) | IA prática do zero | EN |
| [Hugging Face Learn](https://huggingface.co/learn) | Transformers e NLP | EN |
| [Google AI Learn](https://ai.google/build/) | Cursos do Google | EN/PT |
| [Microsoft Learn AI](https://learn.microsoft.com/pt-br/ai/) | Trilhas da Microsoft | PT |
| [Coursera — AI Specializations](https://www.coursera.org/browse/data-science/machine-learning) | Cursos com certificado | EN (leg PT) |
| [Alura — IA](https://www.alura.com.br/cursos-online-data-science) | Cursos em PT | PT |

## 🛠️ Ferramentas e APIs Essenciais

| Ferramenta | Uso | Link |
|---|---|---|
| ChatGPT | Assistente geral OpenAI | [platform.openai.com](https://platform.openai.com) |
| Claude | Assistente Anthropic | [claude.ai](https://claude.ai) |
| Gemini | Assistente Google | [gemini.google.com](https://gemini.google.com) |
| GitHub Copilot | Assistente de código | [github.com/features/copilot](https://github.com/features/copilot) |
| LangChain | Framework para LLMs | [langchain.com](https://www.langchain.com) |
| LangGraph | Agentes com grafos | [langchain-ai.github.io/langgraph](https://langchain-ai.github.io/langgraph/) |
| CrewAI | Multi-agent framework | [crewai.com](https://www.crewai.com) |
| Hugging Face | Modelos open source | [huggingface.co](https://huggingface.co) |
| Ollama | Modelos locais | [ollama.ai](https://ollama.ai) |
| LM Studio | Interface para modelos locais | [lmstudio.ai](https://lmstudio.ai) |

## 📰 Comunidades e Newsletters

- [The Batch — DeepLearning.AI](https://www.deeplearning.ai/the-batch/) — Newsletter semanal de IA (EN)
- [TLDR AI](https://tldr.tech/ai) — Newsletter diária de IA (EN)
- [Ahead of AI](https://magazine.sebastianraschka.com/) — Newsletter técnica sobre LLMs (EN)
- [r/LocalLLaMA — Reddit](https://www.reddit.com/r/LocalLLaMA/) — Comunidade sobre modelos locais (EN)
- [Hugging Face Discord](https://discord.gg/huggingface) — Comunidade técnica (EN)
- [AI Brasil — Telegram](https://t.me/aibrasil) — Comunidade em PT

---

> 🚀 **Este documento é vivo!** Contribua com links, correções e novos recursos.  
> Evite remover conteúdos existentes — a ideia é sempre **somar**.
